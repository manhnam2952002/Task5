...
namespace UWP_025_P2
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void MyCalendarView_SelectedChanged(CalendarView sender, CalendarViewSelectedDatesChangedEventArgs a
            )
        {
        ...
        private string[] selecttionItems = new string[]
        {
